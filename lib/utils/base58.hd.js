...
module.exports = class Base58HD {
    ...
    getKeyPair(coinTypeCode, index, account, change) {
        const path = this.getHdPath(coinTypeCode, index, account, change)
        const root = bip32.fromBase58(baseStr) // 可加入网络信息 得到wif 格式的私钥
