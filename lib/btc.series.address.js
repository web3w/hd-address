...
module.exports = class EthAddress extends Address {
    ...
    async getAddress(index) {
        let _network = this.networkType
        let _coin = this.coin
        let {pri} = await this.getHDPrivateKey(index);
        return privateKeyToAddress(pri, _coin, _network)
    };
    ...
    async getAddressByPublicKey(publicKey) {
        ...
        let _network = this.networkType
        let _coin = this.coin
        return publicKeyToAddress(pub, _coin, _network)
    }
}
